          ...
          <div className="row">
              <div className="">
                  <div className="shadow menu-item-card p-3 mb-3">
                      <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"+resData.data.cloudinaryImageId} className="image-card img-fluid w-100" />
                      <h2 className="restaurant-name">{resData.data.name}</h2>
                      {/* <h1 className="menu-title">{resObj.data.}</h1> */}
                      <h1 className="cuisine">{resData.data.cuisines.join(", ")}</h1>
                      <h6 className="restaurant-name">{resData.data.costForTwoString.toLowerCase()}</h6>
